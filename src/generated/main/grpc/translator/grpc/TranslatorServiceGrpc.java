...
@javax.annotation.Generated(
    ...
    comments = "Source: TranslatorService.proto")
public final class TranslatorServiceGrpc {

  private TranslatorServiceGrpc() {}

  public static final String SERVICE_NAME = "translator.TranslatorService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<translator.grpc.TranslationRequest,
      translator.grpc.TranslationReply> getTranslateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Translate",
      requestType = translator.grpc.TranslationRequest.class,
      responseType = translator.grpc.TranslationReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<translator.grpc.TranslationRequest,
      translator.grpc.TranslationReply> getTranslateMethod() {
    io.grpc.MethodDescriptor<translator.grpc.TranslationRequest, translator.grpc.TranslationReply> getTranslateMethod;
      ...
      synchronized (TranslatorServiceGrpc.class) {
        if ((getTranslateMethod = TranslatorServiceGrpc.getTranslateMethod) == null) {
          TranslatorServiceGrpc.getTranslateMethod = getTranslateMethod =
              io.grpc.MethodDescriptor.<translator.grpc.TranslationRequest, translator.grpc.TranslationReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Translate"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  translator.grpc.TranslationRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  translator.grpc.TranslationReply.getDefaultInstance()))
  ...
  public static abstract class TranslatorServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void translate(translator.grpc.TranslationRequest request,
        io.grpc.stub.StreamObserver<translator.grpc.TranslationReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                translator.grpc.TranslationRequest,
                translator.grpc.TranslationReply>(
  ...
  public static final class TranslatorServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<TranslatorServiceBlockingStub> {
     ...
     * </pre>
     */
    public translator.grpc.TranslationReply translate(translator.grpc.TranslationRequest request) {
  ...
  public static final class TranslatorServiceFutureStub extends io.grpc.stub.AbstractFutureStub<TranslatorServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<translator.grpc.TranslationReply> translate(
        translator.grpc.TranslationRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_TRANSLATE:
          serviceImpl.translate((translator.grpc.TranslationRequest) request,
              (io.grpc.stub.StreamObserver<translator.grpc.TranslationReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class TranslatorServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return translator.grpc.TranslatorProto.getDescriptor();
    }
